...
QUERY_OUT=./forAFL/persistent_output/query_output

RESPONSE_INP=./forAFL/response_input
RESPONSE_OUT=./forAFL/persistent_output/response_output

AFLTEST=./_build/install/default/bin/persistent_test
